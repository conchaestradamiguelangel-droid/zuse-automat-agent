...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| life_blinker | unknown | sin-evidencia-multiregimen | 18 | 1.000 | 0.000 | 0.200 | 3.000 | periodicidad + densidad_estable + tipo_unico | 1.000 | 1.000 | 2d-fixture |
...
| rule_150 | class-3 (additive) | noise-bounded | 8 | 0.250 | 0.750 | 0.000 | 0.750 | densidad_estable + complejidad_alta + temporal_scale_stability | 0.023 | 0.023 | dispersed |
...
| rule_30 | class-3 (chaotic) | noise-bounded | 10 | 0.400 | 0.600 | 0.000 | 1.100 | densidad_estable + complejidad_alta + temporal_scale_stability | 0.021 | 0.021 | dispersed |
...
| synthetic_bloque | unknown | sin-evidencia-multiregimen | 14 | 1.000 | 0.000 | 0.200 | 2.000 | densidad_estable + tipo_unico | n/a | n/a | synthetic-control |
| synthetic_glider | unknown | sin-evidencia-multiregimen | 18 | 1.000 | 0.000 | 0.400 | 3.167 | velocidad_constante + densidad_estable + tipo_unico | n/a | n/a | synthetic-control |
| synthetic_oscilador | unknown | sin-evidencia-multiregimen | 14 | 1.000 | 0.000 | 0.400 | 2.286 | periodicidad + tipo_unico | n/a | n/a | synthetic-control |

`n/a` means the world is a synthetic frame generator rather than a dynamical
system evolved from a perturbable initial condition. No physical one-bit
fragility protocol is defined for those controls.
