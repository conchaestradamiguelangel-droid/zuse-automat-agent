...
| world | eca_class | category | total_visits | non_empty_ratio | noise_ratio | peak_diversity | mean_laws | dominant_signature |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| rule_109 | class-4 | multiregimen-productivo | 15 | 0.667 | 0.333 | 0.667 | 2.000 | densidad_estable + complejidad_alta + frontera_temporal |
...
| rule_137 | class-4 | multiregimen-productivo | 15 | 0.800 | 0.200 | 0.833 | 2.867 | densidad_estable + complejidad_alta + frontera_temporal |
...
| rule_18 | class-3 (moving wave fronts) | multiregimen-productivo | 13 | 0.769 | 0.231 | 0.800 | 2.308 | velocidad_constante + tipo_unico + temporal_scale_stability |
...
| rule_90 | class-3 (additive/XOR) | multiregimen-escala-dependiente | 14 | 0.357 | 0.000 | 0.600 | 0.500 | temporal_scale_stability |
